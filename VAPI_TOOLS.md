...
```json
{
  ...
  "properties": {
    ...
    "fecha": { "type": "string", "description": "Fecha YYYY-MM-DD.", "pattern": "^\\d{4}-\\d{2}-\\d{2}$" },
...
{
  "type": "object",
  "required": ["assistant_id", "telefono", "nombre", "fecha", "hora", "motivo", "canal"],
  "properties": {
    "assistant_id": { "type": "string", "description": "ID del asistente/negocio." },
    "telefono": { "type": "string", "description": "Telefono del cliente." },
...
```json
{
  ...
  "properties": {
    ...
    "hora": { "type": "string", "description": "Hora de la cita a cancelar en formato HH:MM. Opcional si no hay event_id.", "pattern": "^([01]\\d|2[0-3]):[0-5]\\d$" },
    "user_message": { "type": "string", "description": "Mensaje original del usuario. Opcional, recomendado para conservar contexto de llamada." },
    "canal": { "type": "string", "enum": ["vapi"] }
  }
}
